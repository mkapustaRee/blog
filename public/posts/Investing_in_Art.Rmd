...
The last chart displays distribution of the returns per author.  

```{r distribution of returns,warning=F,message=F}
df_soga_tidy %>% 
        drop_na(final_price,diff_price_rel,diff_price_abs) %>% 
        group_by(name) %>% 
...
As expected, majority of authors sold their painting at the same price compared to starting price. Also, high number of authors sell at the lower price compared to starting price. The distribution of returns is showing positive skew. 
